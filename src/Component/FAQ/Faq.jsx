  ...
  return (
    <div className=" rounded-none mx-auto p-6  shadow-lg">
      ...
      <div className="space-y-4">
        {/* FAQ 1 */}
        <div className="collapse collapse-arrow border-2 border-orange-500 bg-white shadow-md rounded-lg">
          <input type="radio" name="my-accordion-2" defaultChecked />
          <div className="collapse-title text-xl font-semibold text-[#3D2B1F] p-4">
            What is this platform about?
          </div>
          <div className="collapse-content bg-[#FFF5E6] p-4 rounded-b-lg">
